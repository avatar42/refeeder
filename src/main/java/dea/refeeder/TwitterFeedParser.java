...
public class TwitterFeedParser implements FeedParserInterface {
	...
	public TwitterFeedParser(FeedListItem feedInfo) {
		item = feedInfo;
		try {
	...
	public static final String SECTION_KEY = "<div class=\"stream-item-header\">";
	public static final String HREF_KEY = "href=";
	public static final String PUB_KEY = "data-time=";
	public static final String TWEET_START_KEY = "<p class=\"js-tweet-text tweet-text\">";
	public static final String TWEET_END_KEY = "</p>";
	public static final String USER_START_KEY = "profile-name\"><s>@</s><b>";
	public static final String USER_END_KEY = "</b></span>";
	...
	private FeedMessage parseTweet(String xml) {
		...
		if (start > -1) {
			start = xml.indexOf(HREF_KEY, start + HREF_KEY.length());
			if (start > -1) {
				start = start + HREF_KEY.length() + 1;
		...
		if (start > -1) {
			start = start + TWEET_START_KEY.length();
			...
			if (message.getDescription().indexOf("�") > -1) {
				log.warn("Special Char found in:" + message.getDescription());
			}
	...
	public static void main(String[] args) {
		...
		TwitterFeedParser rp = new TwitterFeedParser(new FeedListItem(
